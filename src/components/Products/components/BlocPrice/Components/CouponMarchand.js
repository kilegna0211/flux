  ...
  return (
    ...
    { device === 'desktop' &&
      <div className="flux-promo-blocPrice-full_large-device flex flex-column mv3">
        ...
        <div className="fw9 red-rkt"><span className="dib f54">150<sup className="f22 price-euro-full">€</sup></span><span className="price-decimal-full_large-device f22 dib">,99</span></div>
        <div className="dib f12 main-black"><span className="dib">avec le code</span><span className="b"> MarchandPro28</span></div>
      </div>
    }
    { device === 'mob-tab' &&
      <div className="flux-promo-blocPrice-full_small-device flex flex-column mt3">
        ...
        <div className="dib f12 main-black"><span className="dib">avec le code</span><span className="b"> Marchand28</span></div>
      </div>
    }
    </React.Fragment>
  );
